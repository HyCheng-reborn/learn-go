...
| [unit04-packages-and-project-structure](unit04-packages-and-project-structure/README.md) | ✅ | 单 main.go 拆为 model / repository / service 多包：import 路径、大小写导出规则；02 按业务组织 `internal/user` + `cmd/app`，实测 internal 访问限制、小接口与 stutter |
